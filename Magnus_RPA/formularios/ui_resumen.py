...
class Ui_resumen:
    def setupUi(self, resumen):
        ...
        icon = QIcon()
        icon.addFile(
            "../recursos/magnus.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off
        )
        ...
        self.header_top_accent.setObjectName("header_top_accent")
        ...
        self.label.setStyleSheet(
            "color: #1877F2; background: transparent; border: none; padding: 0 8px;"
        )
        ...
        icon1 = QIcon()
        icon1.addFile(
            ":/icons/icons/minimizar.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off
        )
        ...
        icon2 = QIcon()
        icon2.addFile(
            ":/icons/icons/maximizar.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off
        )
        ...
        icon3 = QIcon()
        icon3.addFile(
            ":/icons/icons/cerrar.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off
        )
        ...
        self.lbl_titulo_proceso.setObjectName("lbl_titulo_proceso")
        self.lbl_titulo_proceso.setFont(font1)
        self.lbl_titulo_proceso.setStyleSheet(
        ...
        self.label_2.setStyleSheet(
            "color: #A8B8D8; background: transparent; border: none;"
        )

        self.hl_procesados.addWidget(self.label_2)

        self.sp_proc = QSpacerItem(
            40, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum
        )
        ...
        self.lbl_procesados.setObjectName("lbl_procesados")
        self.lbl_procesados.setFont(font1)
        self.lbl_procesados.setStyleSheet(
            "color: #38D9A9; background: transparent; border: none;"
        )
        self.lbl_procesados.setAlignment(
        ...
        self.sep_1.setStyleSheet(
            "QFrame#sep_1 { background-color: #1E2840; border: none; margin: 6px 0px; }"
        )
        ...
        self.hl_omitidos.setObjectName("hl_omitidos")
        ...
        self.lbl_omitidos.setObjectName("lbl_omitidos")
        self.lbl_omitidos.setFont(font1)
        self.lbl_omitidos.setStyleSheet(
            "color: #4FA3F7; background: transparent; border: none;"
        )
        self.lbl_omitidos.setAlignment(
            Qt.AlignmentFlag.AlignRight
            | Qt.AlignmentFlag.AlignTrailing
            | Qt.AlignmentFlag.AlignVCenter
        )
        ...
        self.sep_2.setStyleSheet(
            "QFrame#sep_2 { background-color: #1E2840; border: none; margin: 6px 0px; }"
        )
        ...
        self.hl_errores.setObjectName("hl_errores")
        ...
        self.lbl_errores.setStyleSheet(
            "color: #E05070; background: transparent; border: none;"
        )
        self.lbl_errores.setAlignment(
            Qt.AlignmentFlag.AlignRight
            | Qt.AlignmentFlag.AlignTrailing
            | Qt.AlignmentFlag.AlignVCenter
        )
        ...
        self.sep_monto.setObjectName("sep_monto")
        self.sep_monto.setMinimumSize(QSize(0, 1))
        self.sep_monto.setMaximumSize(QSize(16777215, 1))
        self.sep_monto.setStyleSheet(
            "QFrame#sep_monto { background-color: #232B3E; border: none; }"
        )
        ...
        self.vl_monto.setObjectName("vl_monto")
        ...
        self.lbl_monto_procesado.setObjectName("lbl_monto_procesado")
        font3 = QFont()
        font3.setFamilies(["72"])
        font3.setPointSize(20)
        font3.setBold(True)
        self.lbl_monto_procesado.setFont(font3)
        self.lbl_monto_procesado.setStyleSheet(
            "color: #A8B8D8; background: transparent; border: none;"
        )
    ...
    def retranslateUi(self, resumen):
        resumen.setWindowTitle(
            QCoreApplication.translate("resumen", "Magnus \u2014 Resumen", None)
        )
        self.label.setText(
            QCoreApplication.translate("resumen", "\U0001f4cb RESUMEN", None)
        )
        self.pushButton_3.setText("")
        self.pushButton_2.setText("")
        self.pushButton.setText("")
        self.lbl_titulo_proceso.setText(
            QCoreApplication.translate(
                "resumen",
                '<html><head/><body><p align="center"><span style=" font-size:12pt;">\u2705 PROCESO COMPLETADO</span></p></body></html>',
                None,
            )
        )
        self.label_2.setText(
            QCoreApplication.translate("resumen", "\u2705  Procesados:", None)
        )
        self.lbl_procesados.setText(QCoreApplication.translate("resumen", "0", None))
        self.label_3.setText(
            QCoreApplication.translate("resumen", "\u26a0\ufe0f  Omitidos:", None)
        )
        self.lbl_omitidos.setText(QCoreApplication.translate("resumen", "0", None))
        self.label_4.setText(
            QCoreApplication.translate("resumen", "\u274c  Errores:", None)
        )
        self.lbl_errores.setText(QCoreApplication.translate("resumen", "0", None))
        self.label_5.setText(
            QCoreApplication.translate("resumen", "MONTO TOTAL PROCESADO", None)
        )
        self.lbl_monto_procesado.setText(
            QCoreApplication.translate("resumen", "$. 0.00", None)
        )
        self.btn_cerrar.setText(QCoreApplication.translate("resumen", "Cerrar", None))
